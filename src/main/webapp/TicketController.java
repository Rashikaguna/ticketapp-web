...
public class TicketController {
	...
	@GetMapping("/login")
	public String registerNewUser(@RequestParam("EmailId") String emailId, @RequestParam("Password") String password,
	...
	public String updateTicket(@RequestParam("EmailId") String emailId, @RequestParam("Password") String password,
			@RequestParam("IssueId") int issueId, @RequestParam("UpdateDescription") String updateDescription,
	...
	public String updateClose(@RequestParam("EmailId") String emailId, @RequestParam("Password") String password,
			@RequestParam("IssueId") int issueId, ModelMap map) throws ServiceException {
	...
	public String viewtickets(@RequestParam("EmailId") String emailId, @RequestParam("Password") String password,
			ModelMap map) throws ServiceException, ValidatorException {
		TicketService ticketService = new TicketService();
		try {
			ticketService.findUserDetail(emailId, password);
		} catch (ServiceException e) {
